...
st.write(f"- The interactivity of the bar chart allows you to compare facilities across all towns. You can filter towns based on a minimum threshold for more targeted analysis, and you can also isolate its legends.")
